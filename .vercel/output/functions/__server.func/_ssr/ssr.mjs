...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v--vVK8n9X.mjs");
...
var manifest = {
	"2c4985e96c199268f7f639534cb5e8e31d6b19d43286bf77416413db60ffde26": {
		...
		importer: () => import("../__root-2-rSYxq_.mjs")
	},
	"498fe86bbffb7f04dea2bf9fbe8305cc75b23455f34b910929983d511e4bf9aa": {
		functionName: "cancelBooking_createServerFn_handler",
		importer: () => import("./bookings-BXVE_XEZ.mjs")
	},
	"a884b014a3ee092e4f0fe9bdf1808981d1d1cc6b0c69d0c40acadcf6acaf3bb6": {
		functionName: "listBookings_createServerFn_handler",
		importer: () => import("./bookings-BXVE_XEZ.mjs")
	},
	"d2017fb40500149d6ef5a5d13ff9979d85dc47c87b63e8860c7777c112319b6e": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BhdpjCnA.mjs").then((n) => n.t),
